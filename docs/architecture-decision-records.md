# clauded — Architecture Decision Records (ADRs)
...
**Decision:** Build clauded from scratch in TypeScript/Node.js as an independent project.
...
*clauded v1.0.0-rc.62 — Architecture Decision Records*
