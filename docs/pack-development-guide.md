...
Packs are capability modules that extend clauded with department-specific tools, skills, and templates. They're the building blocks of the platform — each department enables the packs they need, and any pack can be shared across departments.
...
Just tell clauded what you need:
```
