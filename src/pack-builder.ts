...
Generated by Luna's conversational pack builder.
`;
...
Packs are capability modules that extend Luna with department-specific tools, skills, and templates.
...
Los packs son modulos de capacidad que extienden a Inge Luna con herramientas, habilidades y plantillas especificas por departamento.
